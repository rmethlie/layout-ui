...
export default class Matcher {
  ...
  //
  // @return [Boolean]
  isNitroContact(jid, nitroDomainRegexp) {
    return this.nitroDomainRegexp.test(jid);
  }
  ...
  //
  // @return [Boolean]
  isNitroEmailContact(jid, nitroDomainRegexp) {
    return this.nitroDomainRegexp.test(jid);
  }

  isntNitroEmailContact(jid) {
    return !this.isNitroEmailContact(jid);
  }
